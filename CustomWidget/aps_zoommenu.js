(function () {
    ...
    class ZoomMenuAps extends HTMLElement {
        constructor() {
            super();
        ...
        _submit(e) {
            e.preventDefault();
            let properties = {};
            for (let name of ZoomMenuAps.observedAttributes) {
    ...
    customElements.define("com-fd-djaja-sap-sac-zoommenu-aps", ZoomMenuAps);
})();